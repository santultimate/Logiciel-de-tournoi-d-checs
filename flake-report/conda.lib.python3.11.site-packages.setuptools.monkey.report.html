...
<html>
   <head>
      <title>flake8 violations: .conda/lib/python3.11/site-packages/setuptools/monkey.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="conda.lib.python3.11.site-packages.setuptools.monkey.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               .conda/lib/python3.11/site-packages/setuptools/monkey.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="conda.lib.python3.11.site-packages.setuptools.monkey.source.html#l44">
